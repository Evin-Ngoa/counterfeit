<!-- Modal -->
<div aria-hidden="true" class="onboarding-modal modal fade animated" id="editCustomerModal" role="dialog" tabindex="-1">
            ...
            <form id="frmEditCustomer">
                ...
                <div class="onboarding-side-by-side">
                    ...
                    <div class="onboarding-content with-gradient">
                        <h4 class="onboarding-title"><i class="os-icon os-icon-documents-17"></i> Edit Customer</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div id="edit-customer-msgs"></div>
                                
                                <div class="alert alert-danger" id="edit-error-bag">
                                    <ul id="edit-customer-errors">
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="name" id="name" class="form-control" placeholder="Enter Customer Name" value="">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="$class" id="$class" class="form-control" value="org.evin.book.track.Customer">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary btn-edit-customer" type="button" value="Edit Customer"> Edit Customer</button>
                </div>
            </form>
        </div>
    </div>
