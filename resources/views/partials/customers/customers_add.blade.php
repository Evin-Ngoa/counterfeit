<!-- Modal -->
<div aria-hidden="true" class="onboarding-modal modal fade animated" id="addCustomerModal" role="dialog" tabindex="-1">
        ...
        <div class="modal-content text-center">
            <form id="frmAddCustomer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="name" id="name" class="form-control" placeholder="Enter Customer Name" value="Customer3">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control" placeholder="abc@abc.com" value="customer3@gmail.com">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary btn-add-customer" type="button" value="Save Customer"> Save Customer</button>
                </div>
            </form>
        </div>
    </div>
