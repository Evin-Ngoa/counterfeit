...
<!-- Delete Modal -->
<div aria-hidden="true" class="onboarding-modal modal fade animated" id="deleteCustomerModal" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-md modal-centered" role="document">
        <div class="modal-content text-center">
            <form id="frmDeleteCustomer">
                    ...
                    <div class="onboarding-content with-gradient">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div id="delete-customer-msgs"></div>
                                <div class="alert alert-danger" id="delete-error-bag">
                                    <ul id="delete-customer-errors">
                                    </ul>
                                </div>
                                <p class="text-danger">
                                    <small>
                ...
                <div class="modal-footer">
                    <input id="customer_email_del" name="email" type="hidden" value="">
                    <button class="btn btn-secondary" data-dismiss="modal" type="button"> Close</button>
                    <button class="btn btn-primary btn-delete-customer" id="btn-delete" type="button" value="Delete Customer">Delete Customer</button>
                </div>
            </form>
        </div>
    </div>
