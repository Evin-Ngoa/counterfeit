        ...
        <div class="modal-content text-center">
            <form id="frmDeleteBook">
                    ...
                    <div class="onboarding-content with-gradient">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div id="delete-book-msgs"></div>
                                <div class="alert alert-danger" id="delete-error-bag">
                                    <ul id="delete-book-errors">
                                    </ul>
                                </div>
                                <p class="text-danger">
                                    <small>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary btn-delete-book" id="btn-delete" type="button" value="Delete Book">Delete Book</button>
                </div>
            </form>
        </div>
    </div>
