<!-- Modal -->
<div aria-hidden="true" class="onboarding-modal modal fade animated" id="editPublisherModal" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-lg modal-centered" role="document">
        <div class="modal-content text-center">
            <form id="frmEditPublisher">
                ...
                <div class="onboarding-side-by-side">
                    ...
                    <div class="onboarding-content with-gradient">
                        <h4 class="onboarding-title"><i class="os-icon os-icon-documents-17"></i> Edit Publisher</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div id="edit-publisher-msgs"></div>
                                
                                <div class="alert alert-danger" id="edit-error-bag">
                                    <ul id="edit-publisher-errors">
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="name" id="name" class="form-control" placeholder="Enter Publisher Name" value="">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary btn-edit-publisher" type="button" value="Edit Publisher"> Edit Publisher</button>
                </div>
            </form>
        </div>
    </div>
